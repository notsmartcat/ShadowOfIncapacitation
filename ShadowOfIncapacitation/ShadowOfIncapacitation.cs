...
public class Incapacitation : BaseUnityPlugin
{
    ...
    public void OnEnable()
    {
        try
        {
            ...
            JetFishHooks.Hooks.Apply();
            JetFishHooks.ILHooks.Apply();
    ...
    public static bool IsAbstractCreatureValid(AbstractCreature self)
    {
        if (self != null && (
            ...
            self.creatureTemplate.type == CreatureTemplate.Type.Hazer && ShadowOfOptions.hazy_state.Value != "Disabled" ||
            self.creatureTemplate.TopAncestor().type == CreatureTemplate.Type.JetFish && ShadowOfOptions.jet_state.Value != "Disabled" ||
    ...
    {
        if (self != null && ShadowOfOptions.den_revive.Value && (
            ...
            self.creatureTemplate.type == CreatureTemplate.Type.Hazer && ShadowOfOptions.hazy_state.Value == "Incapacitation, Cheating Death and Den Revive" ||
    ...
    {
        if (self != null && ShadowOfOptions.cheat_death.Value && (
            ...
            self.creatureTemplate.type == CreatureTemplate.Type.Hazer && ShadowOfOptions.hazy_state.Value != "Disabled" && ShadowOfOptions.hazy_state.Value != "Incapacitation Only" ||
            self.creatureTemplate.TopAncestor().type == CreatureTemplate.Type.JetFish && ShadowOfOptions.jet_state.Value != "Disabled" && ShadowOfOptions.jet_state.Value != "Incapacitation Only" ||
