...
internal class Hooks
{
    ...
    static void VultureUpdate(On.Vulture.orig_Update orig, Vulture self, bool eu)
    {
        ...
        try
        {
            ...
            {
                self.tuskCharge = self.AI.preyInTuskChargeRange ? Mathf.Clamp(self.tuskCharge + 0.005f, 0f, 1f) : Mathf.Clamp(self.tuskCharge - 0.000111111f, 0f, 1f);
            }
            else
            {
