...
internal class ILHooks
{
    ...
    static void ILCentipedeUpdate(ILContext il)
    {
        ...
        {
            Incapacitation.Logger.LogInfo(all + "Could not find match for ILCentipedeUpdate Small target!");
        }
        ...
        }))
        {
            ...
            val.Emit(OpCodes.Ldarg_0);
            val.EmitDelegate(CentipedeUpdate);
            val.Emit(OpCodes.Brtrue_S, target);
        }
        else
        {
            Incapacitation.Logger.LogInfo(all + "Could not find match ILCentipedeUpdate Small!");
        }
        #endregion
        */
    ...
    public static bool CentipedeUpdate(Creature self)
    {
        return IsComa(self);
    }
