...
internal class Hooks
{
    ...
    static void DeerUpdate(On.Deer.orig_Update orig, Deer self, bool eu)
    {
        ...
        try
        {
            ...
            self.resting = (data.stunTimer > 0 || self.wormGrassBelow) ? Mathf.Min(1f, self.resting + 0.016666668f) : Mathf.Max(0f, self.resting - 0.00625f);
            ...
            self.mainBodyChunk.vel.y += self.gravity * 1.2f * self.resting;
